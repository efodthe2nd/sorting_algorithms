 ...
 * @list: A pinter to the head of a doubly linked list of integers.
 * @tail: A pointer to the tail of the doubly linked list
 * @shaker: A pointer to the current swappind node of the cocktail shaker
 */
void swap_node_ahead(listint_t **list, listint_t **tail, listint_t **shaker)
{
 ...
 * of integers with thet node behind it.
